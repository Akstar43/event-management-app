...
class UserDashboard: 
    def __init__(self, root, username): 
        ...
        self.welcome = tk.Label(self.nav, text='Welcome User',font=('Calibri',18),background='blue',foreground='white')
        self.welcome.pack(side=tk.LEFT, fill=tk.X, padx= 0)
...
class AdminDashboard:
    def __init__(self, root, username):
        ...
        self.nav.pack(fill=tk.X)
        # Welocme moessahe
        self.welcome = tk.Label(self.nav, text='Welcome Admin',font=('Calibri',24),background='blue',foreground='white')
        self.welcome.pack(side=tk.LEFT, fill=tk.X, padx= 0)
